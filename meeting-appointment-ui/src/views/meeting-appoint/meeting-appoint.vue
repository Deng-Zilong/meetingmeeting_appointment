<template>
        ...
        <el-form ref="ruleFormRef" :model="formData" :rules="rules">
          <div class="appoint-row">
            ...
            <el-form-item label="参会人" prop="meetingPeople">
              <el-input class="meeting-people" v-model="formData.meetingPeople" readonly :prefix-icon="Plus" placeholder="添加参会人"
                @click="handlePerson" />
            </el-form-item>
          </div>
          <div class="appoint-row">
            <el-form-item label="开始时间" prop="startTime">
              <el-time-select v-model="formData.startTime" :start="timeStart" step="00:15" :end="timeEnd" placeholder="请选择" />
            </el-form-item>
            <el-form-item label="结束时间" prop="endTime">
              <el-time-select v-model="formData.endTime" :min-time="formData.startTime" :start="timeStart" step="00:15" :end="timeEnd"
                placeholder="请选择" />
            </el-form-item>
          </div>
          <div class="appoint-row">
            <el-form-item label="日期" prop="date" class="row-date">
              <el-date-picker v-model="formData.date" type="date" class="date" :disabled-date="disabledDate" placeholder="选择日期" />
            </el-form-item>
  ...
  onMounted(() => {
    console.log("进入预约页面");
    console.log(routes);
    const {id, meetingRoomId, title, description, meetingRoomName, status, createdBy, users} = routes.query;
